...
<body>
                     ...
                     <div class="card mb-30 px-3 py-3">
                        <table id="tableProfileList" class="table">
                           ...
                           @foreach($profilelist as $data)
                              <tr id="Profile_{{ $data->id_profile }}" style="cursor: pointer;" onclick="openProfile({{ $data->id_profile }}, '{{ url('/profilemanagement/getprofile') }}')">
   ...
   <script src="{{ url('/') }}/js/pages/profilemanagement.js"></script>
</body>
