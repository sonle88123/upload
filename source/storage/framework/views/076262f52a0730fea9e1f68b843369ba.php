...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendor/daterangepicker/daterangepicker.css">
   <!-- ======= END BEGIN PAGE LEVEL PLUGINS STYLES ======= -->

   <!-- ======= MAIN STYLES ======= -->
   <link rel="stylesheet" href="<?php echo e(url('/')); ?>/css/style.css">
   <link rel="stylesheet" href="<?php echo e(url('/')); ?>/css/kms.css?v=0.0.1">
   <!-- ======= END MAIN STYLES ======= -->
...
<body>
                              ...
                              <div class="user-profile-nav d-flex justify-content-xl-between align-items-xl-center flex-column flex-xl-row">
                                 ...
                                 <div class="profile-info d-flex align-items-center">
                                    <div class="profile-pic me-3">
                                       <img id="profileAvatar" src="<?php echo e(url('/')); ?>/img/media/profile-pic.jpg" alt="">
                                    </div>
                                       ...
                                       <li>
                                          <a class="conncetion" href="#">
                                             <div class="btn-circle me-20">
                                                <img src="<?php echo e(url('/')); ?>/img/svg/user-check.svg" alt="" class="svg">
                                             </div>
                                             <div class="font-14">
                                          ...
                                          <div class="form-group mb-4 mb-lg-0">
                                             ...
                                             <div class="dashboard-date style--four">
                                                <span class="input-group-addon">
                                                   <img src="<?php echo e(url('/')); ?>/img/svg/calender.svg" alt="" class="svg">
                                                </span>
   ...
   <script src="<?php echo e(url('/')); ?>/vendor/chartjs/Chart.min.js"></script>
   <script src="<?php echo e(url('/')); ?>/vendor/datatables/datatables.min.js"></script>
   <script src="<?php echo e(url('/')); ?>/vendor/moment/moment.min.js"></script>
      ...
      $(document).ready(function() {
         ...
         function handleProfileSelection() {
            ...
            if (profile) {
               ...
               $.ajax({
                  url: "<?php echo e(url('/performance/facebook/detail')); ?>", // The route to fetch profile details
                  method: 'POST',
                  data: {
                     id: profile.id
                  },
...
</html><?php /**PATH D:\xampp\htdocs\kms-main\source\resources\views/facebookperformance.blade.php ENDPATH**/ ?>