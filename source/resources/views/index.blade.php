                        ...
                        <div class="col-sm-4 col-md-3">
                           ...
                           <div class="card mb-30">
                              <div class="state2 style--two">
                                    ...
                                    <h2>{{ number_format($totalProfiles) }}</h2>
                              </div>
                           </div>
                           <!-- End Card -->
                        </div>
                        <div class="col-sm-4 col-md-3">
                           ...
                           <div class="card mb-30">
                              <div class="state2 style--three">
                                    ...
                                    <h2>{{ number_format($totalImageProfile) }}</h2>
                              </div>
                           </div>
                           <!-- End Card -->
                        </div>
                        <div class="col-sm-4 col-md-3">
                           ...
                           <div class="card mb-30">
                              <div class="state2">
                                    ...
                                    <h2>{{ number_format($nationcount) }}</h2>
                              </div>
                           </div>
                           <!-- End Card -->
                        </div>
                              ...
                              <div class="apex_pie3-chart-legend card-body font-14">
                                 ...
                                 <div class="d-flex mb-10 align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="c_name">{{ $data['nationality'] }}</div>
                                    </div>
                                    
                                    <div class="d-flex align-items-center">
                                       <div><span class="bold black mr-2">{{ $data['count'] }}</span> Profile</div>
                                    </div>
                                 </div>
                              ...
                              <div class="social-statics">
                                 ...
                                 <div class="d-flex justify-content-between align-items-center followers">
                                    <div class="content">
                                       ...
                                       <h3 class="total-fb-follower">{{ number_format($totalFBFollow) }}</h3>
                                    </div>
                                    <div class="content">
                                       <p class="font-14 mb-2 l-height1">Reach</p>
                                       <h3 class="total-fb-reach">{{ number_format($totalFBReach) }}</h3>
                                    </div>
                                    <div class="content">
                                       <p class="font-14 mb-2 l-height1">Engagement</p>
                                       <h3 class="total-fb-engagement">{{ number_format($totalFBEngagement) }}</h3>
                                    </div>
                                 </div>
                              </div>
                              <!-- End Social Statics -->
