      ...
      <ul class="nav">
        ...
        <li class="<?php if(isset($menu) && $menu=='generativeai'): ?> active sub-menu-opened <?php endif; ?> has-sub-item">
          ...
          <ul class="nav sub-menu">
            ...
            <li class="<?php if(isset($submenu) && $submenu=='virtual-anyone'): ?> active <?php endif; ?>"><a href="<?php echo e(url('/')); ?>/generativeai/virtual-anyone">Virtual Anyone</a></li>
...
<!-- End Sidebar --><?php /**PATH D:\API_REQUEST\Trending_AI\KSM2\kms\source\resources\views/parts/sidebar.blade.php ENDPATH**/ ?>