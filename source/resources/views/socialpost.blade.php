...
<head>
   ...
   <link rel="stylesheet" href="{{url('/')}}/vendor/dropzone/dropzone.min.css">
...
<body>
                                        ...
                                        <form id="ImageFBPostForm" class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-4">
                                                    <img id="profileAvatar" src="{{ url('/') }}/img/avatar/avatar-user.png" alt="" class="avatar img-70">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img id="ImageProfile1" src="{{ url('/') }}/img/TrendiTaglineNgang.png" alt="" width=100%>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
   ...
   <script src="{{ url('/') }}/vendor/dropzone/dropzone.min.js"></script>
   <!-- ======= End BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS ======= -->
    ...
    <script>
        ...
        $('#GetPrompt').click(function() {
            ...
            $.ajax({
                url: "{{ url('/generativeai/getpromptsocialpost') }}",
                type: 'POST',
                data: {
        ...
        $('#GetPost').click(function() {
            ...
            $.ajax({
                url: "{{ url('/generativeai/getsocialpost') }}",
                type: 'POST',
                data: {
                    profileCode: profileCode,
                    prompt: prompt,
